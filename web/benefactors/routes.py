...
def bs():
    ...
    postal_code = "v3e3b5"
    city = "pharmacy"
    a= f"https://www.google.com/maps/embed/v1/search?key=AIzaSyCZ2UdTtgsGg7Jbx7UmtnGPFh_pVRi2n4U&q='{postal_code}'+'{city}'"
    payload = {}
    headers= {}
    response = requests.request("GET", a, headers=headers, data = payload)
    # return response.text
    # return render_template('bs1.html', b=response.text)
    return render_template('bs.html', a=a)
